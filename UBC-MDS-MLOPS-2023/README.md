...
With over 20 years of experience in managing software development projects and shaping technical strategies, I am a seasoned professional who has worked with a broad range of organizations—from large enterprises and FAANG companies to agile startups. My career has been marked by scaling teams and delivering innovative solutions. I earned a master's degree in machine learning and data science from UBC in 2023, which has deepened my passion for integrating cloud computing with artificial intelligence. This fusion helps businesses stay ahead of the curve and unlock the transformative potential of technology. Currently, I serve as the lead architect at a Vancouver-based startup, where I oversee technical direction, security, and engineering operations. 
